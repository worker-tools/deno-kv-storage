import { AllowedKey, Key } from 'https://cdn.skypack.dev/kv-storage-interface@^0.2.0/index.d.ts';
import { Base64Decoder, Base64Encoder } from 'https://cdn.skypack.dev/base64-encoding?dts';

/**
 * A simple string serialization for IndexedDB-like keys.
 * 
 * Since most key value stores only allows string keys, but KV Storage allows complex (composed) IndexedDB-like keys,
